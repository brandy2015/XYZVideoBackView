...
public class XYZVideoBackView {
    ...
    public func play(view: UIView,
                     ...
                     setAudioSessionAmbient: Bool = true,end: @escaping () -> Void) throws {
        ...
        play(
            ...
            setAudioSessionAmbient: setAudioSessionAmbient, end: end)
    ...
    public func play(view: UIView,
                     ...
                     isMuted: Bool = true,
                     willLoopVideo: Bool = false,
                     setAudioSessionAmbient: Bool = true,end: @escaping () -> Void) {
        cleanUp()
